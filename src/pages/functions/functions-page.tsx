        ...
        <Row gutter={16}>
          ...
          <Col span={6}>
            <div className={styles.filterCount}>
              {functionsPage && (
                <span>
                  {functionsPage.total} function{functionsPage.total > 1 ? "s" : ""}{" "}
                  found
                </span>
              )}
            </div>
      ...
      {isLoading ? (
        ...
        <>
          <Row gutter={[16, 16]} className={styles.functionsGrid}>
            {functionsPage?.items.map((func) => (
              <Col xs={24} sm={24} md={12} lg={8} xl={6} key={func.id}>
                <FunctionCard functionDetail={func} />
              </Col>
            ))}
          </Row>
